        ...
        <div className="flex items-center gap-2 lg:gap-3">
          ...
          <div className="flex items-center gap-2 lg:gap-3 pl-2 lg:pl-3">
            <div className="relative">
              <div className="w-8 h-8 lg:w-9 lg:h-9 bg-gradient-to-br from-primary via-primary/90 to-primary/90 rounded-full flex items-center justify-center shadow-lg ring-2 ">
